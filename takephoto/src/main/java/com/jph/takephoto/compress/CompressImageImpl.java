...
public class CompressImageImpl implements CompressImage {
    ...
    public static CompressImage of(Context context, CompressOptions config, ArrayList<TImage> images, CompressImage.CompressListener listener) {
    ...
    private CompressImageImpl(Context context, CompressOptions config, ArrayList<TImage> images, CompressImage.CompressListener listener) {

...
public interface TakePhoto {
     ...
     * 裁剪多张图片
     *
     * @param multiCrop 要裁切的图片的路径以及输出路径
     * @param options      裁剪配置
     */
    void onCrop(MultiCrop multiCrop, CropOptions options) throws TException;
     ...
     */
    void onEnableCompress(CompressOptions config, boolean showCompressDialog);

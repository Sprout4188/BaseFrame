package com.sprout.frame.baseframe.utils.statusbar;
...
public class SystemBarTintManager {
    ...
    public SystemBarTintManager(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            // check theme attrs
            int[] attrs = {android.R.attr.windowTranslucentStatus,  //顶部状态栏是否透明
                    android.R.attr.windowTranslucentNavigation};    //底部导航栏是否透明
